...
from zopeskel.vars import IntVar, BooleanVar, StringVar
...
""",
    ...
    def _checkPortAvailable(self, port):
        ...
        try:
            ...
            if e.args[0] == errno.ECONNREFUSED:
                return
            msg = "Error checking port availability: %s"
            raise BadCommand(msg % e.args[1])
    ...
    def check_vars(self, vars, cmd):
        ...
        if not vars["plone"].startswith("3."):
